...
def number_of_steps(text: str) -> int:
    list_of_jumps = [int(number) for number in text.split('\n')]
    size_of_maze = len(list_of_jumps)

    idx = 0
    for i in itertools.count(1):
        jump = list_of_jumps[idx]
        list_of_jumps[idx] += 1
        idx += jump
        if idx >= size_of_maze:
            return i
...
def number_of_steps_v2(text: str) -> int:
    list_of_jumps = [int(number) for number in text.split('\n')]
    size_of_maze = len(list_of_jumps)
